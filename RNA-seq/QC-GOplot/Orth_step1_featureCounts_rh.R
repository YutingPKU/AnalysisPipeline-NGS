...
bam.files <- list.files(path = "data/bamfiles/macaque/", full.names = T, pattern = "bam")

anno <- fread("XSAnno/XSAnno.byself.Ensemble.hg19TorheMac8.rheMac8.withname.bed", header = F, sep = "\t")
...
saveRDS(count, file = "data/macaque.feature.count.byXSAnno.genes.rds")
